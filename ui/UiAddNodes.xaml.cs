    ...
    public partial class UiAddNodes : Window
    {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                PublicParamerters.CommunicationRangeRadius = r;
...
#pragma warning restore CS0219 // The variable 'rd' is assigned but its value is never used
                    ...
                    for (int id = 0; id <NodesNumber; id++)
                    {
                        ...
                        x = RdmGenerator(MainWindow.Canvas_SensingFeild.Width * 0.9);
                        //  Thread.Sleep(TimeSpan.FromMilliseconds(1));
                        y = RdmGenerator(MainWindow.Canvas_SensingFeild.Height * 0.9);
                      //  Thread.Sleep(TimeSpan.FromMilliseconds(1));
